...
|--------------------------------------------------------------------------*/
		...
		val seat11 = new Seat(false,true,1000,"A10", "Economy")
		val seat12 = new Seat(false,true,3000,"A10", "Business")
		val seat13 = new Seat(true,true,5000,"A10", "First")
		
		val seat21 = new Seat(true,true,3000,"A10", "Economy")
		val seat22 = new Seat(true,true,4000,"A10", "Business")
		val seat23 = new Seat(false,true,7000,"A10", "First")
		
		val seat31 = new Seat(true,true,1300,"A10", "Economy")
		val seat32 = new Seat(false,true,3800,"A10", "Business")
		val seat33 = new Seat(true,true,6500,"A10", "First")
		
		val seat41 = new Seat(false,true,2200,"A10", "Economy")
		val seat42 = new Seat(true,true,4110,"A10", "Business")
		val seat43 = new Seat(false,true,9810,"A10", "First")
		
		val seat51 = new Seat(true,true,1590,"A10", "Economy")
		val seat52 = new Seat(false,true,3800,"A10", "Business")
		val seat53 = new Seat(true,true,5800,"A10", "First")
		
		val seat61 = new Seat(true,true,9000,"A10", "Economy")
		val seat62 = new Seat(true,true,12000,"A10", "Business")
		val seat63 = new Seat(false,true,15300,"A10", "First")
		
		val seat71 = new Seat(false,true,1200,"A10", "Economy")
		val seat72 = new Seat(false,true,3700,"A10", "Business")
		val seat73 = new Seat(true,true,6900,"A10", "First")
		
		val seat81 = new Seat(true,true,10000,"A10", "Economy")
		val seat82 = new Seat(true,true,13900,"A10", "Business")
		val seat83 = new Seat(true,true,15760,"A10", "First")
